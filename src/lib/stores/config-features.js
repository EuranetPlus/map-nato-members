export const config = {
	mapTitle: 'map-nato-members', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-nato-members.vercel.app', // The url provided when deploying the map on Vercel
